...
class CreditVC: UIViewController {
    ...
    let libraries = ["Dreamio iOS project", "IQKeyboardManagerSwift", "WSTagsField", "SCLAlertView"]
    let urls = ["https://github.com/boldlion/dreamio-app", "https://github.com/hackiftekhar/IQKeyboardManager",
