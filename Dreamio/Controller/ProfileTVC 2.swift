...
class ProfileTVC: UITableViewController {
    ...
    func setTableViewFooter() {
        ...
        footerLabel.text = "Cannaseur \(Bundle.main.releaseVersionNumberPretty) \(Bundle.main.releaseVersionNumber!)"
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.section == 2 && indexPath.row == 1 {
            // Support
            showMailComposeVC(with: "I need help", email: "cannaseurapp@gmail.com", body: nil)
        }
        else if indexPath.section == 3 && indexPath.row == 0 {
            // Feedback Cell
            showMailComposeVC(with: "Feedback", email: "cannaseurapp@gmail.com", body: nil)
        }
        else if indexPath.section == 3 && indexPath.row == 1 {
            // Report a bug cell
            showMailComposeVC(with: "I found a bug", email: "cannaseurapp@gmail.com", body: nil)
        }
        else if indexPath.section == 5 && indexPath.row == 0 {
            // Request Account Deletion
            guard let email = user.email else { return }
            showMailComposeVC(with: "Account Deletion", email: "cannaseurapp@gmail.com", body: "I would like delete my account and all of my data. \n \n My email is: \(email)")
        }
    }
    ...
    func showMailComposeVC(with subject: String, email: String, body: String?) {
        if MFMailComposeViewController.canSendMail() {
            ...
            SCLAlertView().showError("Hold on!", subTitle: "Since you have not configured your email in the Settings app, please contact us with your request at cannaseurapp@gmail.com")
        }
    }
