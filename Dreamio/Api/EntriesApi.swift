...
class EntriesApi {
    ...
    //**** MARK: - Save Entry
    //****************************************//
    func saveEntry(forNotebookUid uid: String,photoUrls: [String], entryUid: String, title: String, content: String, onSuccess: @escaping () -> Void, onError: @escaping (_ error: String) -> Void) {
        let creationDate = Int(Date().timeIntervalSince1970)
        let dict = ["title": title, "content": content,"photoUrls":photoUrls, "created": creationDate, "notebookId": uid] as [String : Any]
    ...
    //**** MARK: - Update Entry
    //****************************************//
    func updateEntryWithUid(uid: String, title: String,photoUrls:[String], content: String, onSuccess: @escaping () -> Void, onError: @escaping (_ errorMessage: String) -> Void) {
        let dict = ["title": title, "content": content,"photoUrls":photoUrls] as [String : Any]
