...
struct Colors {
    static let bgGradientColor1 = UIColor.hex("#5b7c1d")
    static let bgGradientColor2 = UIColor.hex("#8bbe2d")
    static let bgGradientColor3 = UIColor.hex("#9dd13d")
    
    static let purpleLight = UIColor.hex("#9dd13d")
    static let purpleDarker = UIColor.hex("#5b7c1d")
}
...
struct Segues {
    ...
    static let NotebooksToShareNotebookVC = "Segue_NotebooksToShareNotebookVC"
